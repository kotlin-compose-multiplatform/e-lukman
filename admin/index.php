    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord  menu-active menu-icon-doctor-active" >
                        <a href="index.php" class="non-style-link-menu  non-style-link-menu-active"><div><p class="menu-text">Dolandyryş paneli</p></a></div></a>
        </td>
        </tr>
        <tr class="menu-row">
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="Submit" value="Gözleg" class="login-btn btn-primary-soft btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;">
                    ...
                    <td colspan="4">
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Indiki geljekki duşuşyklar <?php
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Ine, 7 güne çenli ýetip gelýän duşuşyklara çalt giriş<br>
                                        Has giňişleýin maglumat @Bellige alynmalar bölüminde bar.
                                    </p>
                                ...
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;text-align:right;padding-right:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Ine, 7 güne çenli meýilleşdirilýän Geljekki sessiýalara çalt giriş<br>
                                        @Gün tertibi bölüminde bar bolan aýratynlyklary goşuň, aýyryň we köp aýratynlyklary.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="appointment.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Ahli bellikleri görkeziň</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                        <a href="schedule.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Ahli sessiýalary görkeziň</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
